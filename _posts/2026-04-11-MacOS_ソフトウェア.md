...
```text
Screenshot tool for
designersfront-end engineersmobile developersthose who care about pixels
```

## [BetterDisplay](https://github.com/waydabber/BetterDisplay)

```text
Custom Resolutions, XDR/HDR Extra Brightness, Virtual Screens, Picture in Picture, Soft-Disconnect, Configuration and EDID overrides, DDC Control, Color Mode Selection, Syncing, Layout Protection and More!
```
